...
<body>
<form name="form1" method="post" action="eliminarTodo.php">
...

{
 ...
 <table width="1043" height="77" border="1">
   <tr>
     ...
     <td width="200"><div align="center">cantiExistencia</div></td>
     <td width="186"><div align="center">tama&ntilde;o</div></td>
     <td width="221"><div align="center">precio</div></td>
   </tr>
   <tr>
     ...
     <td align="center" valign="middle"><? print $row->nombre; ?>&nbsp;</td>
      <td align="center" valign="middle"><? print $row->cantiExistencia; ?>&nbsp;</td>
     <td align="center" valign="middle"><? print $row->tamaño; ?>&nbsp;</td>
	  <td align="center" valign="middle"><? print $row->precio; ?>&nbsp;</td>
   </tr>
   <tr>
     <td colspan="5"><label>
       <div align="center">
